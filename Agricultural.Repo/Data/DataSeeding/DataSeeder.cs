    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(PlanetContext DbContext)
        {
            try
            {
                ...
                {
                    var plantsDataPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Data", "DataSeeding", "plants_seeding_data .json");
                ...
                {
                    var plantImagesPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Data", "DataSeeding", "plants_images.json");
